...
void print_usage(int argc, const char* argv[]) {
    ...
    printf("  --scheduler {discrete, karras, exponential, ays, gits, simple, beta, smoothstep, bezier} Denoiser sigma scheduler (default: discrete)\n");
    ...
    printf("  --high-noise-scheduler {discrete, karras, exponential, ays, gits, simple, beta, smoothstep, bezier} Denoiser sigma scheduler (default: discrete)\n");
